...
export const PROFILE_READ_SCOPES = [ALL, ALL_READ, XAPI_ALL, XAPI_READ, XAPI_PROFILE_ALL];

export const STATEMENT_WRITE_SCOPES = [ALL, XAPI_ALL, XAPI_STATEMENTS_WRITE];
